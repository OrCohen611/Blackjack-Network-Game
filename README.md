...
### 3. Gameplay
1. The client detects the server and asks for the number of rounds.
2. Follow the on-screen prompts: type 'H' to Hit or 'S' to Stand.
3. After the rounds end, the client returns to listening mode.

## Requirements
* Python 3.x
* No external libraries required (standard socket, struct, and threading).